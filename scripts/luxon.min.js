export var luxon = (function (e) {
  ...
  function Ie(e, t) {
    var n,
      r,
      i = {};
    for (n in e) !f(e, n) || (null != (r = e[n]) && (i[t(n)] = Ve(r)));
    return i;
  }
  function xe(e, t) {
  ...
  var je = [
    ...
    ze = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
    qe = ["M", "T", "W", "T", "F", "S", "S"];
  function _e(e) {
    switch (e) {
      case "narrow":
  ...
  function Ct(e, t, n, r, i, o, a) {
    ...
    return (
      a && (t.second = l(a)),
      e && (t.weekday = 3 < e.length ? je.indexOf(e) + 1 : ze.indexOf(e) + 1),
      t
    );
  }
  var Ft =
    ...
    return (t = Array.prototype).concat.apply(
      ...
      e.map(function (e) {
        return (
          (t = n),
          (e = e).literal ||
          null == (t = Sn(h.macroTokenToFormatOpts(e.val), t)) ||
          t.includes(void 0)
            ? e
            : t
        );
  ...
  function Tn(t, e, n) {
    ...
    var o,
      ...
      u = i
        ? ((u = null),
          w((o = i).z) || (u = p.create(o.z)),
          w(o.Z) || ((u = u || new b(o.Z)), (s = o.Z)),
          w(o.q) || (o.M = 3 * (o.q - 1) + 1),
          w(o.h) ||
            (o.h < 12 && 1 === o.a
              ? (o.h += 12)
  ...
  function xn(e) {
    var t = e.year;
    return s({ year: t, ordinal: Dn(t, e.month, e.day) }, Ce(e));
  }
  function Cn(e) {
    var t = e.year,
      n = En(t, e.ordinal);
  ...
  function er(e, t) {
    ...
    if (w(e.year)) u = r;
      ...
      for (var i = g(Bn); !(o = i()).done; ) {
        var o = o.value;
        w(e[o]) && (e[o] = Yn[o]);
      }
      var a = Fn(e) || Zn(e);
      if (a) return L.invalid(a);
      var a = Un(e, n.offset(r), n),
        u = a[0],
        a = a[1];
    }
    ...
    (p.now = function () {
      ...
      (p.fromFormat = function (e, t, n) {
        ...
        var r = n,
          ...
          a = i[2],
          i = i[3];
        return i ? p.invalid(i) : Rn(r, o, n, "format " + t, e, a);
      }),
      ...
      (p.parseFormatForOpts = function (e, t) {
        e = Sn(e, O.fromObject((t = void 0 === t ? {} : t)));
        return e
          ? e
              .map(function (e) {
                return e ? e.val : null;
      ...
      (p.expandFormat = function (e, t) {
        return (
          void 0 === t && (t = {}),
          bn(h.parseFormat(e), O.fromObject(t))
            .map(function (e) {
              return e.val;
            })
            .join("")
    ...
    return (
      ...
      (e.setZone = function (e, t) {
        ...
        return (e = T(e, S.defaultZone)).equals(this.zone)
          ...
          ? ((n = this.ts),
            (r || t) &&
              ((r = e.offset(this.ts)), (n = Un(this.toObject(), r, e)[0])),
            zn(this, { ts: n, zone: e }))
          : p.invalid(An(e));
      }),
      (e.reconfigure = function (e) {
      ...
      (e.set = function (e) {
        ...
        n
          ...
          : (t = Cn(s({}, xn(this.c), e)));
        i = Un(t, this.o, this.zone);
        return zn(this, { ts: i[0], o: i[1] });
      }),
      (e.plus = function (e) {
        return this.isValid ? zn(this, Pn(this, I.fromDurationLike(e))) : this;
      }),
      (e.minus = function (e) {
        return this.isValid
          ? zn(this, Pn(this, I.fromDurationLike(e).negate()))
          : this;
      }),
